...
@section('content')
    ...
    <div class="mb-5">
        <form action="{{ route('categories.update', ['id' => $category->id]) }}" method="POST">
            ...
            <h4 class="fw-bold text-center mb-3">Editando categoria</h4>
            <div class="row justify-content-center mb-2">
                <div class="col-md-3">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control rounded-3" id="name" name="name"
                            placeholder="Sem abreviações" value="{{ old('name', $category->name) }}">
                ...
                <div class="col-md-1">
                    <div class="form-floating mb-3">
                        <input type="number" class="form-control" id="shard_code" name="shard_code" placeholder="Insira"
                            value="{{ old('shard_code', $category->shard_code) }}" oninput="updateSpan()"
                ...
                <div class="col-md-3 mb-3">
                    <p class="bg-secondary p-2 rounded-3 text-center fw-bold">Participação no código interno:<br>
                        ...
                        CO2-<span id="showingShardCode" class="badge bg-primary" style="font-size: 15px;"></span><span
                            class="text-danger">XXXXX</span>
                    </p>
                </div>
            </div>
            <div class="text-center">
                <button class="btn btn-lg btn-success rounded-3" title="Editar categoria" type="submit"

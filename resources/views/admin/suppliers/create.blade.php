...
@section('content')
    ...
    <div class="mb-5">
        <form action="{{ route('suppliers.store') }}" method="POST">
            ...
            <h4 class="fw-bold text-center mb-3">Cadastrando fornecedor</h4>
            ...
            <div class="contacts-fields" style="display: none;" x-data="{
                contacts: [
                    @if (count(old('contacts', [])) > 0) @foreach (old('contacts', []) as $oldContact)
                        ...
                        @endforeach
                    @else 
                        { name: '', telephone: '', celphone: '', whatsapp: false, email: '' } @endif
                ]
            }">
            ...
            <div class="text-center">
                <button class="btn btn-lg btn-success rounded-3" title="Cadastrar fornecedor" type="submit"

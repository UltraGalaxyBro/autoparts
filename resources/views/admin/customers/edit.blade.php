...
@section('content')
    ...
    <div class="mb-5">
        <form action="{{ route('customers.update', ['id' => $customer->id]) }}" method="POST">
            ...
            <h4 class="fw-bold text-center mb-3">Editando cliente</h4>
                ...
                <div class="col-md-4">
                    <div class="form-floating mb-3">
                        <select autocomplete="off" class="form-select select2" id="customer_level_id"
                            ...
                            <option value="{{ $customer->customer_level_id }}" selected>{{ $customer->customerLevel->name }}
                            </option>
                            @foreach ($levels as $level)
                                @if ($level->id != $customer->customer_level_id)
                ...
                <div class="col-md-3">
                    <div class="form-floating">
                        <input autocomplete="off" type="text" class="form-control rounded-3" id="celphone"
                            name="celphone" placeholder="Sem abreviações"
                            value="{{ old('celphone', $customer->celphone) }}">
                    ...
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" role="switch" id="whatsappSign" name="whatsappSign"
                            {{ old('whatsappSign') == 'Sim' || $customer->whatsapp == 'Sim' ? 'checked' : '' }}>
                ...
                <div class="col-md-3">
                    <div class="form-floating mb-3">
                        <select autocomplete="off" class="form-select" id="type_buyer" name="type_buyer"
                            ...
                            <option value="PF"
                                {{ old('type_buyer') == 'PF' || $customer->type_buyer == 'PF' ? 'selected' : '' }}>Pessoa
                                Física</option>
                            <option value="PJ"
                                {{ old('type_buyer') == 'PJ' || $customer->type_buyer == 'PJ' ? 'selected' : '' }}>Pessoa
                                Jurídica
                            </option>
                        </select>
                ...
                <div class="col-md-3" id="pf-div">
                    <div class="form-floating mb-3">
                        <input autocomplete="off" type="text" class="form-control rounded-3" id="cpf"
                            name="cpf" placeholder="Sem abreviações" value="{{ old('cpf', $customer->cpf) }}">
                ...
                <div class="col-md-4">
                    <div class="form-floating mb-3">
                        <input autocomplete="off" type="text" class="form-control rounded-3" id="company"
                            name="company" placeholder="Sem abreviações" value="{{ old('company', $customer->company) }}">
                ...
                <div class="col-md-3">
                    <div class="form-floating mb-3">
                        <input autocomplete="off" type="text" class="form-control rounded-3" id="cnpj"
                            name="cnpj" placeholder="Sem abreviações" value="{{ old('cnpj', $customer->cnpj) }}">
                ...
                <div class="col-md-3">
                    <div class="form-floating mb-3">
                        <input autocomplete="off" type="text" class="form-control rounded-3" id="ie"
                            name="ie" placeholder="Sem abreviações" value="{{ old('ie', $customer->ie) }}">

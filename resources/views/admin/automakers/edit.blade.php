...
@section('content')
    ...
    @endcan
    <div class="mb-5">
        <form action="{{ route('automakers.update', ['id' => $automaker->id]) }}" method="POST">
            @csrf
            @method('put')

            <h4 class="fw-bold text-center mb-3">Editando montadora</h4>
            <div class="row justify-content-center mb-2">
                <div class="col-md-3">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control rounded-3" id="name" name="name"
                            placeholder="Sem abreviações" value="{{ old('name', $automaker->name) }}">
                ...
                <div class="col-md-1">
                    <div class="form-floating mb-3">
                        <input type="number" class="form-control" id="shard_code" name="shard_code" placeholder="Insira"
                            value="{{ old('shard_code', $automaker->shard_code) }}" oninput="updateSpan()"
            ...
            <div class="text-center">
                <button class="btn btn-lg btn-success rounded-3" title="Editar montadora" type="submit"

...
@section('content')
    ...
    <div class="pt-3 pb-2 mb-3 text-end">
        <a href="{{ route('budgets.show', ['id' => $budget_id]) }}" class="btn btn-sm btn-dark">
            <i class="fa-solid fa-people-pulling"></i> Cancelar replicação em nova cotação
        </a>
        <a href="{{ route('budgets.index') }}" class="btn btn-sm btn-secondary">
            Listar cotações
        </a>
    </div>
    <div class="mb-5">
        <form action="{{ route('budgets.store') }}" method="POST">
            ...
            <h4 class="fw-bold text-center mb-3">Gerando cotação com produtos replicados</h4>
            ...
            <div class="text-center">
                <button class="btn btn-success rounded-3" title="Gerar cotação replicada" type="submit"
                    onclick="this.innerText = 'Gerando...'">Gerar cotação replicada como nova</button>
            </div>
        </form>
    </div>

...
@section('content')
    ...
    <div class="mb-5">
        <form action="{{ route('budgets.store') }}" method="POST">
            ...
            <h4 class="fw-bold text-center mb-3">Gerando cotação</h4>
                            ...
                            <select autocomplete="off" class="form-select select2" id="user_id" name="user_id"
                                ...
                                @foreach ($sellers as $seller)
                                    <option value="{{ $seller->id }}"
                                        {{ old('user_id') == $seller->id ? 'selected' : null }}>
                                        {{ $seller->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <select autocomplete="off" class="form-select select2" id="customer_id" name="customer_id"
                            ...
                            @foreach ($clients as $client)
                                <option value="{{ $client->id }}"
                                    {{ old('customer_id') == $client->id ? 'selected' : null }}>
                                    {{ $client->user->name }}
                ...
                <div class="col-md-3">
                    <div class="form-floating mb-3">
                        <input autocomplete="off" type="date" class="form-control rounded-3" id="validity"
                            name="validity" placeholder="Aparecerá para o cliente" value="{{ old('validity') }}"
            ...
            <div class="row justify-content-center mb-2">
                <div class="col-md-2">
                    <div class="form-floating mb-3">
                        <select autocomplete="off" class="form-select" id="payment_method" name="payment_method"
                            ...
                            <option value="" disabled selected>Selecione</option>
                            <option value="PIX" {{ old('payment_method') == 'PIX' ? 'selected' : null }}>PIX</option>
                            <option value="BOLETO" {{ old('payment_method') == 'BOLETO' ? 'selected' : null }}>BOLETO
                            </option>
                            <option value="CARTÃO DE CRÉDITO"
                                {{ old('payment_method') == 'CARTÃO DE CRÉDITO' ? 'selected' : null }}>CARTÃO DE CRÉDITO
                            </option>
                            <option value="CHEQUE" {{ old('payment_method') == 'CHEQUE' ? 'selected' : null }}>CHEQUE
                            </option>
                        </select>
                ...
                <div class="col-md-2" id="details-bol-div" style="display: none;">
                    <div class="form-floating mb-3">
                        <select autocomplete="off" class="form-select" id="payment_details_bol" name="payment_details_bol"
                            aria-label="Tipo da unidade de medida.">
                            <option value="" disabled selected>Selecione</option>
                            <option value="3" {{ old('payment_details_bol') == '3' ? 'selected' : null }}>3</option>
                            <option value='15' {{ old('payment_details_bol') == '15' ? 'selected' : null }}>15</option>
                            <option value='20' {{ old('payment_details_bol') == '20' ? 'selected' : null }}>20
                            </option>
                            <option value='28' {{ old('payment_details_bol') == '28' ? 'selected' : null }}>28</option>
                            <option value='30' {{ old('payment_details_bol') == '30' ? 'selected' : null }}>30</option>
                            <option value='15/30' {{ old('payment_details_bol') == '15/30' ? 'selected' : null }}>15/30
                            </option>
                            <option value='15/30/45' {{ old('payment_details_bol') == '15/30/45' ? 'selected' : null }}>
                                15/30/45</option>
                            <option value='20/40' {{ old('payment_details_bol') == '20/40' ? 'selected' : null }}>20/40
                            </option>
                            <option value='20/40/60' {{ old('payment_details_bol') == '20/40/60' ? 'selected' : null }}>
                                20/40/60
                            </option>
                            <option value='28/56' {{ old('payment_details_bol') == '28/56' ? 'selected' : null }}>28/56
                            </option>
                            <option value='28/56/84' {{ old('payment_details_bol') == '28/56/84' ? 'selected' : null }}>
                                28/56/84</option>
                            <option value='28/56/84/112'
                                {{ old('payment_details_bol') == '28/56/84/112' ? 'selected' : null }}>28/56/84/112
                            </option>
                            <option value='30/45' {{ old('payment_details_bol') == '30/45' ? 'selected' : null }}>
                                30/45</option>
                            <option value='30/45/60' {{ old('payment_details_bol') == '30/45/60' ? 'selected' : null }}>
                                30/45/60</option>
                            <option value='30/60' {{ old('payment_details_bol') == '30/60' ? 'selected' : null }}>30/60
                            </option>
                            <option value='30/60/90' {{ old('payment_details_bol') == '30/60/90' ? 'selected' : null }}>
                                30/60/90</option>
                        </select>
                ...
                <div class="col-md-2" id="details-credit-div" style="display: none;">
                    <div class="form-floating mb-3">
                        <select autocomplete="off" class="form-select" id="payment_details_credit"
                            ...
                            <option value="" disabled selected>Selecione</option>
                            <option value="1X" {{ old('payment_details_credit') == '1X' ? 'selected' : null }}>1X
                            </option>
                            <option value="2X" {{ old('payment_details_credit') == '2X' ? 'selected' : null }}>2X
                            </option>
                            <option value="3X" {{ old('payment_details_credit') == '3X' ? 'selected' : null }}>3X
                            </option>
                            <option value="4X" {{ old('payment_details_credit') == '4X' ? 'selected' : null }}>4X
                            </option>
                            <option value="5X" {{ old('payment_details_credit') == '5X' ? 'selected' : null }}>5X
                            </option>
                            <option value="6X" {{ old('payment_details_credit') == '6X' ? 'selected' : null }}>6X
                            </option>
                            <option value="7X" {{ old('payment_details_credit') == '7X' ? 'selected' : null }}>7X
                            </option>
                            <option value="8X" {{ old('payment_details_credit') == '8X' ? 'selected' : null }}>8X
                            </option>
                            <option value="9X" {{ old('payment_details_credit') == '9X' ? 'selected' : null }}>9X
                            </option>
                            <option value="10X" {{ old('payment_details_credit') == '10X' ? 'selected' : null }}>10X
                            </option>
                            <option value="11X" {{ old('payment_details_credit') == '11X' ? 'selected' : null }}>11X
                            </option>
                            <option value="12X" {{ old('payment_details_credit') == '12X' ? 'selected' : null }}>12X
                            </option>
                        </select>
                ...
                <div class="col-md-3">
                    <div class="form-floating mb-3">
                        <select autocomplete="off" class="form-select" id="freight_type" name="freight_type"
                            ...
                            <option value="CIF" {{ old('freight_type') == 'CIF' ? 'selected' : null }}>
                                CIF (Cliente paga)
                            </option>
                            <option value="FOB" {{ old('freight_type') == 'FOB' ? 'selected' : null }}>
                                FOB (CO2 paga)
                            </option>
                            <option value="RETIRADA EM LOJA"
                                {{ old('freight_type') == 'RETIRADA EM LOJA' ? 'selected' : null }}>
                                RETIRADA EM LOJA
                            </option>
                        </select>
                ...
                <div class="col-md-2 mb-3" id="freight-price-div" style="display: none;">
                    ...
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch" id="freight_price_null"
                            name="freight_price_null" {{ old('freight_price_null') ? 'checked' : '' }}>
                ...
                <div class="col-md-3 mb-3">
                    <div class="form-floating">
                        <input autocomplete="off" type="number" step="0.01" class="form-control rounded-3"
                            id="expenses" name="expenses" value="{{ old('expenses') }}" placeholder="Se necessário">
            ...
            <div x-data="{
                products: [
                    @if (count(old('products', [])) > 0) @foreach (old('products', []) as $oldProduct)
                            {
                                description: '{{ $oldProduct['description'] }}',
                                supplier_id: @if (isset($oldProduct['supplier_id'])) '{{ $oldProduct['supplier_id'] }}' @else '' @endif,
                ...
                @endforeach
                @else { description: '', supplier_id: '', supplier_reference: '', cost: '', deadline: '1', price: '', quantity: '1' }
                @endif
            ],
                ...
                <div class="col-md-5">
                    <div class="form-floating mb-3">
                        <textarea class="form-control rounded-3" oninput="this.value = this.value.toUpperCase()"
                            placeholder="Somente em site" id="chassis_number" name="chassis_number">{{ old('chassis_number') }}</textarea>
                        <label for="chassis_number">Nº do chassi <i class="fa-solid fa-o text-warning"></i></label>
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="form-floating mb-3">
                        <textarea class="form-control rounded-3" placeholder="Somente em site" id="observation" name="observation">{{ old('observation') }}</textarea>
            ...
            <div class="text-center">
                <button class="btn btn-lg btn-success rounded-3" title="Gerar cotação" type="submit"
                    onclick="this.innerText = 'Gerando...'">Gerar cotação</button>
            </div>
        </form>
    </div>

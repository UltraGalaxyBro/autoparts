...
@section('content')
    ...
    <div class="mb-5">
        <form action="{{ route('levels.store') }}" method="POST">
            ...
            <h4 class="fw-bold text-center mb-3">Cadastrando nível para clientes</h4>
            <div class="row justify-content-center mb-2">
                ...
                <div class="col-md-9">
                    <div class="form-floating mb-3">
                        <textarea class="form-control rounded-3" placeholder="" id="description" name="description">{{ old('description') }}</textarea>
                ...
                <div class="col-md-3">
                    <div class="form-floating mb-3">
                        <input type="number" step="0.01" class="form-control rounded-3" id="discount" name="discount"
                            placeholder="Sem abreviações" value="{{ old('discount') }}">
            ...
            <div class="text-center">
                <button class="btn btn-lg btn-success rounded-3" title="Cadastrar nível para clientes" type="submit"

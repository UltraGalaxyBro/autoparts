...
@section('content')
    ...
    <div class="mb-5">
        <form action="{{ route('products.update', ['id' => $product->id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <h4 class="fw-bold text-center mb-3">Editando produto</h4>
            <div class="row justify-content-center mb-2">
                <div class="col-md-3">
                    <div class="form-floating mb-3">
                        <input autocomplete="off" type="text" class="form-control rounded-3" id="name"
                            name="name" placeholder="Sem abreviações" value="{{ old('name', $product->name) }}"
                        ...
                        <select autocomplete="off" class="form-select select2" id="automaker_id" name="automaker_id"
                            ...
                            @foreach ($automakers as $automaker)
                                <option value="{{ $automaker->id }}"
                                    {{ old('automaker_id', $product->automaker_id) == $automaker->id ? 'selected' : null }}>
                                    {{ $automaker->name }} -
                ...
                <div class="col-md-3 mb-3">
                    <div class="form-floating mb-1">
                        <input autocomplete="off" type="text" class="form-control rounded-3" id="original_code"
                            name="original_code" placeholder="Sem abreviações"
                            value="{{ old('original_code', $product->original_code) }}"
                            oninput="this.value = this.value.toUpperCase()">
                    ...
                    <div class="form-check form-switch" id="original_code_null_div" style="display: none;">
                        <input class="form-check-input" type="checkbox" role="switch" id="original_code_null"
                            name="original_code_null"
                            {{ old('original_code_null') || is_null($product->original_code) ? 'checked' : '' }}>
                ...
                <div class="col-md-3 mb-3">
                    <div class="form-floating mb-1">
                        <input autocomplete="off" type="text" class="form-control rounded-3" id="brand_code"
                            name="brand_code" placeholder="Sem abreviações"
                            value="{{ old('brand_code', $product->brand_code) }}"
                            oninput="this.value = this.value.toUpperCase()">
                    ...
                    <div class="form-check form-switch" id="brand_code_null_div" style="display: none;">
                        <input class="form-check-input" type="checkbox" role="switch" id="brand_code_null"
                            name="brand_code_null"
                            {{ old('brand_code_null') || is_null($product->brand_code) ? 'checked' : '' }}>
                ...
                <div class="col-md-6 mb-3">
                    <div class="form-floating">
                        <textarea placeholder="Códigos similares a este produto" class="form-control rounded-3" id="cross_code"
                            name="cross_code" oninput="this.value = this.value.toUpperCase()">{{ old('cross_code', $product->cross_code) }}</textarea>
            ...
            <div x-data="{
                ...
                @foreach ($product->productLocations as $productLocation)
                            {
                                supplier_id: '{{ $productLocation->supplier_id }}',
                                supplier_code: '{{ $productLocation->supplier_code }}',
                                headquarter_id: '{{ $productLocation->headquarter_id }}',
                                indoor_location: '{{ $productLocation->indoor_location }}',
                                quantity: '{{ $productLocation->quantity }}',
                                stock_alert_at: '{{ $productLocation->stock_alert_at }}'
                            }, @endforeach
                @endif
            ]
            }">
            ...
            <div class="row justify-content-center mb-2">
                <div class="col-md-2">
                    <div class="form-floating mb-3">
                        <select autocomplete="off" class="form-select" id="condition" name="condition"
                            ...
                            <option value="Novo"
                                {{ old('condition', $product->condition) == 'Novo' ? 'selected' : null }}>Novo</option>
                            <option value="Seminovo"
                                {{ old('condition', $product->condition) == 'Seminovo' ? 'selected' : null }}>Seminovo
                            </option>
                        </select>
                ...
                <div class="col-md-2">
                    <div class="form-floating mb-3">
                        <select autocomplete="off" class="form-select" id="measure" name="measure"
                            ...
                            <option value="UNID" {{ old('measure', $product->measure) == 'UNID' ? 'selected' : null }}>
                                UNID</option>
                            <option value="KG" {{ old('measure', $product->measure) == 'KG' ? 'selected' : null }}>KG
                            </option>
                            <option value="LT" {{ old('measure', $product->measure) == 'LT' ? 'selected' : null }}>LT
                            </option>
                        </select>
                ...
                <div class="col-md-2">
                    <div class="form-floating mb-3">
                        <input autocomplete="off" type="number" step="0.01" class="form-control rounded-3"
                            id="cost" name="cost" placeholder="" value="{{ old('cost', $product->cost) }}">
                ...
                <div class="col-md-2">
                    <div class="form-floating mb-3">
                        <input autocomplete="off" type="number" step="0.01" class="form-control rounded-3"
                            id="price" name="price" placeholder="" value="{{ old('price', $product->price) }}">
                ...
                <div class="col-md-2">
                    <div class="form-floating mb-3">
                        <input autocomplete="off" type="number" class="form-control rounded-3" id="ncm"
                            name="ncm" placeholder="" value="{{ old('ncm', $product->ncm) }}">
            ...
            <div class="row justify-content-center mb-1">
                <div class="col-md-2">
                    <div class="form-floating mb-3">
                        <select autocomplete="off" class="form-select" id="visible" name="visible"
                            ...
                            <option value="Sim" {{ old('visible', $product->visible) == 'Sim' ? 'selected' : null }}>
                                Sim</option>
                            <option value="Não" {{ old('visible', $product->visible) == 'Não' ? 'selected' : null }}>
                                Não</option>
                        </select>
                ...
                <div class="col-md-5 conditional-div">
                    <div class="form-floating mb-3">
                        <textarea class="form-control rounded-3" placeholder="Somente em site" id="aplication" name="aplication">{{ old('aplication', $product->aplication) }}</textarea>
                        <label for="aplication">Aplicação</label>
                    </div>
                </div>
                <div class="col-md-3 conditional-div">
                    <div class="form-floating mb-3">
                        <textarea class="form-control rounded-3" placeholder="Somente em site" id="description" name="description">{{ old('description', $product->description) }}</textarea>
                ...
                <div class="col-md-2 conditional-div">
                    <div class="form-floating mb-3">
                        <select autocomplete="off" class="form-select" id="sale" name="sale"
                            ...
                            <option value="Não" {{ old('sale', $product->sale) == 'Não' ? 'selected' : null }}>Não
                            </option>
                            <option value="Sim" {{ old('sale', $product->sale) == 'Sim' ? 'selected' : null }}>Sim
                            </option>
                        </select>
                ...
                <div class="col-md-2">
                    <div class="form-floating mb-3">
                        <input autocomplete="off" type="date" class="form-control rounded-3" id="sale_period_until"
                            ...
                            value="{{ old('sale_period_until', $product->sale_period_until) }}">
            ...
            <div class="conditional-div row justify-content-center mb-1">
                <div class="col-md-2">
                    <div class="form-floating mb-3">
                        <input autocomplete="off" type="number" step="0.01" class="form-control rounded-3"
                            id="height" name="height" placeholder="" value="{{ old('height', $product->height) }}">
                ...
                <div class="col-md-2">
                    <div class="form-floating mb-3">
                        <input autocomplete="off" type="number" step="0.01" class="form-control rounded-3"
                            id="width" name="width" placeholder="" value="{{ old('width', $product->width) }}">
                ...
                <div class="col-md-2">
                    <div class="form-floating mb-3">
                        <input autocomplete="off" type="number" step="0.01" class="form-control rounded-3"
                            id="lenght" name="lenght" placeholder="" value="{{ old('lenght', $product->lenght) }}">
                ...
                <div class="col-md-2">
                    <div class="form-floating mb-3">
                        <input autocomplete="off" type="number" step="0.01" class="form-control rounded-3"
                            id="weight" name="weight" placeholder="" value="{{ old('weight', $product->weight) }}">
                ...
                <div class="col-md-2">
                    <div class="form-floating mb-3">
                        <select autocomplete="off" class="form-select" id="freight" name="freight"
                            aria-label="Sobre tal produto ficar visível aos usuários">
                            <option value="">--</option>
                            <option value="SÓ RETIRADA"
                                {{ old('freight', $product->freight) == 'SÓ RETIRADA' ? 'selected' : null }}>SÓ
                                RETIRADA</option>
                            <option value="CORREIOS"
                                {{ old('freight', $product->freight) == 'CORREIOS' ? 'selected' : null }}>CORREIOS
                            </option>
                            <option value="TRANSPORTADORA"
                                {{ old('freight', $product->freight) == 'TRANSPORTADORA' ? 'selected' : null }}>
                ...
                <div class="col-md-2">
                    <div class="form-floating mb-3">
                        <select autocomplete="off" class="form-select" id="packaging" name="packaging"
                            ...
                            <option value="">--</option>
                            <option value="CAIXA"
                                {{ old('packaging', $product->packaging) == 'CAIXA' ? 'selected' : null }}>CAIXA</option>
                            <option value="PLÁSTICO/ROLO"
                                {{ old('packaging', $product->packaging) == 'PLÁSTICO/ROLO' ? 'selected' : null }}>
                                PLÁSTICO/ROLO</option>
                            <option value="ENVELOPE"
                                {{ old('packaging', $product->packaging) == 'ENVELOPE' ? 'selected' : null }}>ENVELOPE
                            </option>
                            <option value="CAIXOTE"
                                {{ old('packaging', $product->packaging) == 'CAIXOTE' ? 'selected' : null }}>CAIXOTE
                            </option>
                            <option value="NÃO POSSUI"
                                {{ old('packaging', $product->packaging) == 'NÃO POSSUI' ? 'selected' : null }}>NÃO
                                POSSUI</option>
                        </select>
            ...
            <div class="row justify-content-center text-center mb-1">
                <div class="col-md-6">
                    <div class="form-group text-center">
                        ...
                        <input type="file" value="" class="form-control-file" id="img" name="img"
                            placeholder="">
                        <input type="hidden" id="pressedDelButton" name="pressedDelButton" value="Não">
                        <img src="{{ asset('img/products/' . $product->main_img) }}" class="rounded" width="140"
                ...
                <div class="col-md-6">
                    <div id="extra-img-1" class="form-group text-center mb-2"
                        @if ($product->main_img == null || $product->main_img == 'default-image.png') style="display:none;" @endif>
                        <label><small><strong>1ª imagem extra</strong></small></label>
                        <input type="file" value="" class="form-control-file" id="img1" name="img1"
                            placeholder="">
                        <input type="hidden" id="pressedDelButton1" name="pressedDelButton1" value="Não">
                        <img src="{{ asset('img/products/extra/' . $product->extra_img) }}" class="rounded"
                            width="75" height="75" id="targetImg1" alt="1ª imagem extra representativa">
                        <button type="button" title="Remover esta imagem" id="imgDel1"
                            class="btn btn-sm btn-danger imgDel">
                            <i class="fa-solid fa-file-circle-xmark"></i>
                        </button>
                    </div>
                    <div id="extra-img-2" class="form-group text-center mb-2"
                        @if ($product->extra_img == null || $product->extra_img == 'default-image.png') style="display:none;" @endif>
                        <label><small><strong>2ª imagem extra</strong></small></label>
                        <input type="file" value="{{ $product->extra_img2 }}" class="form-control-file"
                            id="img2" name="img2" placeholder="">
                        <input type="hidden" id="pressedDelButton2" name="pressedDelButton2" value="Não">
                        <img src="{{ asset('img/products/extra/' . $product->extra_img2) }}" class="rounded"
                            width="75" height="75" id="targetImg2" alt="2ª imagem extra representativa">
            ...
            <div class="text-center mt-5">
                <button class="btn btn-lg btn-success rounded-3" title="Editar produto" type="submit"
                    onclick="this.innerText = 'Editando...'">
                    Editar
                </button>
            </div>
        </form>
